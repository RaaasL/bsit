...
?>
        <div class="szachownica">
            ...
            <div class="offer gray">
                <div class="ico">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                    	 viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                    <g>
                    	<g>
                    		<path d="M151,0v150h60v30h90v-30h60V0H151z M331,120H181V30h150V120z"/>
                    	</g>
                    </g>
                    <g>
                    	<g>
                    		<path d="M0,332v150h60v30h90v-30h60V332H0z M180,452H30v-90h150V452z"/>
                    	</g>
                    </g>
                    <g>
                    	<g>
                    		<path d="M302,332v150h60v30h90v-30h60V332H302z M482,452H332v-90h150V452z"/>
                    	</g>
                    </g>
                    <g>
                    	<g>
                    		<polygon points="271,241 271,210 241,210 241,241 90,241 90,302 120,302 120,271 392,271 392,302 422,302 422,241 		"/>
                    	</g>
                    </g>
                    <g>
                    </g>
                ...
                <div class="ico">
                    <svg width="100px" height="100px" viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <g id="37.-Video-camera" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                            <g transform="translate(2.000000, 7.000000)" stroke="#222F3E" stroke-width="4">
            ...
            <div class="clear"></div>
                <div class="offer gray">
                    <div class="ico">
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M19.5,22.8c0.6,0,1-0.5,1-1.1c0-0.6-0.4-1-1-1
...
?>
        <div class="row_about">
            <div class="image">
                <img src="img/1.jpg" alt="Poznajmy się">
            </div>
        ...
        <div class="row_about">
            ...
            <div class="image2">
                <img src="img/2.jpg" alt="Poznajmy się">
            </div>
            <div class="clear"></div>
        </div>
        <div class="row_about">
            <div class="image">
                <img src="img/3.jpg" alt="Poznajmy się">
            </div>
            <div class="about_desc">
                <h2>Kim jesteśmy?</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum. In culpa qui officia deserunt mollit anim id est laborum.</p>
            ...
            <div class="row_facts">
                <div class="circle">
                    ...
                    <div class="title_facts">
                        <span>Obsługiwane firmy</span>
                    </div>
                </div>
                <div class="circle circle_middle">
                    <div class="number">
                        <span>168</span>
                    </div>
                    <div class="title_facts">
                        <span>Wykonanych instalacji</span>
                    </div>
                </div>
                <div class="circle">
                    <div class="number">
                    ...
                    <div class="title_facts">
                        <span>Założonych monitoringów</span>
                    </div>
                </div>
                <div class="clear"></div>
                <div class="circle">
                ...
                <div class="circle">
                    ...
                    <div class="title_facts">
                        <span>Sztuk sprzedanego sprzętu</span>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
...
!-->
                    ...
                    <div class="contact_details">
                        <ul>
                            ...
                            <li><a href="tel:+48503468650"><span>tel: 503-468-650</span></a></li>
                            <li><a href="mailto:bartosz.slupny@bsit.pl"><span>bartosz.slupny@bsit.pl</span></a></li>
                        </ul>
                    </div>
                    <div class="contact_details_mobile">
                        <span class="contact_details_title">BS IT</span><br>
                        <span>Bartosz Słupny</span><br>
                        <a href="https://goo.gl/maps/YAKvT8gLYvWQewLg7" target="_blank"><span>ul. Ku Słońcu 32</span></a><br>
                        <span>71-080 Szczecin</span><br>
                        <span>NIP: 852-25-17-717</span><br>
                        <a href="tel:+48503468650"><span>tel: 503-468-650</span></a><br>
                        <a href="mailto:bartosz.slupny@bsit.pl"><span>bartosz.slupny@bsit.pl</span></a>
                    </div>
                </div>
            </div>
            <div class="clear"></div>
